    ...
    <div className="md:mt-44 mt-20">
      ...
      <div className="flex border-[1px] rounded-lg w-full max-w-fit md:w-fit mx-auto mt-7 py-2 md:px-4 px-2 md:gap-2 gap-0 bg-light-one">
        {items.map((value, index) => (
          <div
            key={"pricing-" + index}
            className={`md:text-lg text-xs cursor-pointer py-2 md:w-[123px] h-[49px] w-20 text-center font-semibold rounded-lg  hover:bg-accent-five transition ${
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 mt-11 gap-6">
        ...
        <div>
          ...
          <div className="mt-5 border-2 justify-between px-9 py-4 rounded-2xl items-center hidden md:flex bg-light-one border-light-ten">
            ...
            <div className="flex items-center bg-accent-five text-accent px-8 py-3 rounded-xl font-semibold  hover:bg-accent-ten transition cursor-pointer">
              Contact Us&nbsp;
